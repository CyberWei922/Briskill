...
enum ToolDescriptorCatalog {
    static let all: [ToolDescriptor] = [
        ...
        descriptor("selection.readText", "读取选中文字", "文字", "读取其他应用当前选中的文字。", output: "text", permissions: ["accessibility"], risk: .medium),
        descriptor("selection.replaceText", "替换选中文字", "文字", "将其他应用当前选区替换为指定文字。", arguments: [argument("text", "text", "替换后的文字")], output: "text", permissions: ["accessibility", "confirmation_required"], risk: .high),
